...
|-----------------------|---------------------|----------|---------------------------------------------------------------------|
| `clientId`            | `String`            | Yes      | OAuth 2.0 client ID registered in AIC                              |
...
| `clientSecret`        | `String`            | No       | Only for confidential clients (avoid in mobile apps)               |
| `acrValues`           | `String`            | No       | Authentication Context Class Reference values                       |
...
| `additionalParameters`| `Map<String,String>`| No       | Extra query parameters to add to the authorization request         |
...
> In-memory cached data is **plain text**. On rooted devices with memory dump capability,
...
Ensure your OAuth 2.0 client in AIC is configured as:
